...
export const metadata: Metadata = { title: "Teilnahmebedingungen" };
...
export default async function TeilnahmebedingungenPage() {
  const page = await prisma.legalPage.findUnique({ where: { slug: "teilnahmebedingungen" } });
  if (!page) notFound();
